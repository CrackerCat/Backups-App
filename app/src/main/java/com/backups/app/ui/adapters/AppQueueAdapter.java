...
public class AppQueueAdapter extends RecyclerView.Adapter<AppQueueAdapter.BackupsViewHolder> {
    ...
    @NonNull
    @Override
    public BackupsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BackupsViewHolder holder, int position) {
        if(!mDataSet.isEmpty()) {
